   ...
   <body>
      ...
      <div class="Header" id="Home">
         <nav class="navbar fixed-top">
            <div class="container">
               <a class="navbar-brand" href="#">Yayasan Insan Amanah Barokah</a>
               <div class="collapse_menu deactive">
                  ...
                  <ul class="nav">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="#AboutMe">Tentang Yayasan</a>
                     </li>
                     <li class="nav-item">
               ...
               <div class="row Section">
                  <div class="col">
                     <div class="box">
                        ...
                        <p>Selamat datang di aplikasi Sistem Penggajian Karyawan <br>Yayasan Insan Amanah Barokah</p>
                     </div>
                  </div>
                  <div class="col headerImg" style="background-image: url('<?php echo base_url()?>assets/img/background.jpg');"></div>
         ...
         <div class="Section">
            <div class="text-center">
               ...
               <div class="subHeading">
                  Berikut informasi lebih lengkap tentang website <br>penggajian karyawan Yayasan Insan Amanah Barokah
            </div>
               ...
               <div class="row">
                  <div class="col-md-6 col-lg-4 col-xl-3 ">
                     <div class="card">
                        ...
                        <div class="body">
                           ...
                           <div id="panel1">aplikasi ini dibuat untuk membantu Yayasan dalam proses penggajian karyawan</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-3 ">
                     <div class="card">
                        ...
                        <div class="body">
                           ...
                           <div id="panel2">Hanya Admin yang dapat mengaksesnya, admin juga dapat menambahkan, menghapus dan mengubah data data yang ada </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-3 ">
                     <div class="card">
                        ...
                        <div class="body">
                           ...
                           <div id="panel3">Karyawan bisa melihat riwayat gaji, melihat data diri, mengubah password dan dan cetak slip gaji.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-3 ">
                     <div class="card">
                        ...
                        <div class="body">
                           <div class="title"><font size="4"><b><i>Website Yayasan</font></b></i></div>
                           <a div="" href="https://yayasaninsanamanahbarokah.blogspot.com/2021/04/yayasan-insan-amanah-barokah.html"</a><div id="flip4"><font color="white">Baca Selengkapnya</font>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="content">
               <div class="team row">
                  <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                     <div class="card">
                        <div class="TopImg">
                           <img src="<?php echo base_url(); ?>assets/img/inaba.png" class="rounded-circle w-100 d-block">
                        </div>
                        <div class="TeamInfo text-center">
                           <div class="Name">PENGGAJIAN KARYAWAN</div>
                           <div class="Job">Yayasan Insan Amanah Barokah</div>
                           <div class="social_links">
                              <div class="social">
                                 <a class="" href="http://www.facebook.com/inabapeduli.org"><i class="fab fa-facebook" aria-hidden="true"></i></a>
                              </div>
                              <div class="social">
                                 <a class="" href="https://instagram.com/inabapeduli?igshid=MzRlODBiNWFlZA=="><i class="fab fa-instagram" aria-hidden="true"></i></a>
                              </div>
                              <div class="social">
                                 <a class="" href="https://youtube.com/@inabapeduli"><i class="fab fa-youtube" aria-hidden="true"></i></a>
                              </div>
                           </div>
                        </div>
                     </div>
